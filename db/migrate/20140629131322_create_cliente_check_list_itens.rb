class CreateClienteCheckListItens < ActiveRecord::Migration
  def change
    create_table :cliente_check_list_itens do |t|
    ...
    add_index :cliente_check_list_itens, :check_list_item_id
    add_index :cliente_check_list_itens, :cliente_id
