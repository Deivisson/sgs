$(document).ready(function() {
	...
	var TIPO_OS_TREINAMENTO = 0
 	...
 	$("a#ordem-servico-link").click(function(e){
    var url = $(this).attr('href');
		callOrdemServicoModalForm(url);    
		e.preventDefault();
  });

	function  callOrdemServicoModalForm(url){
	  ...
	  dialog_form.load(url + ' #modal-container', function(){
	    ...
	    $(this).dialog('option',"title","Nova Ordem de Serviço");
