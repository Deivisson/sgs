...
describe CompromissosController do
  ...
  def mock_compromisso(stubs={})
    mock_compromisso ||= mock_model(Compromisso, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all compromissos as @compromissos" do
      Compromisso.stub(:all) { [mock_compromisso] }
      get :index
      assigns(:compromissos).should eq([mock_compromisso])
    end
  end

  describe "GET show" do
    it "assigns the requested compromisso as @compromisso" do
      Compromisso.stub(:find).with("37") { mock_compromisso }
      get :show, :id => "37"
      assigns(:compromisso).should be(mock_compromisso)
    end
  end

  describe "GET new" do
    it "assigns a new compromisso as @compromisso" do
      Compromisso.stub(:new) { mock_compromisso }
      get :new
      assigns(:compromisso).should be(mock_compromisso)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created compromisso as @compromisso" do
        Compromisso.stub(:new).with({'these' => 'params'}) { mock_compromisso(:save => true) }
        post :create, :compromisso => {'these' => 'params'}
        assigns(:compromisso).should be(mock_compromisso)
      end

      it "redirects to the created compromisso" do
        Compromisso.stub(:new) { mock_compromisso(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved compromisso as @compromisso" do
        Compromisso.stub(:new).with({'these' => 'params'}) { mock_compromisso(:save => false) }
        post :create, :compromisso => {'these' => 'params'}
        assigns(:compromisso).should be(mock_compromisso)
      end

      it "re-renders the 'new' template" do
        Compromisso.stub(:new) { mock_compromisso(:save => false) }
        post :create, :compromisso => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested compromisso as @compromisso" do
        Compromisso.stub(:find) { mock_compromisso(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:compromisso).should be(mock_compromisso)
      end
    ...
    describe "with invalid params" do
      it "assigns the compromisso as @compromisso" do
        Compromisso.stub(:find) { mock_compromisso(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:compromisso).should be(mock_compromisso)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the compromissos list" do
      Compromisso.stub(:find) { mock_compromisso }
      delete :destroy, :id => "1"
