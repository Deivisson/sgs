...
describe "cliente_infras/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit cliente_infra form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cliente_infras_path(@cliente_infra), :method => "post" do
