...
describe "ordem_servicos/new.html.erb" do
  before(:each) do
    assign(:ordem_servico, stub_model(OrdemServico,
      :cliente => nil,
  ...
  it "renders new ordem_servico form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => ordem_servicos_path, :method => "post" do
